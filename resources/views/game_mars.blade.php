...
<nav class="navbar navbar-expand navbar-light navbar-bg">
    ...
    <div class="navbar-collapse collapse">
        <div class="navbar-title">GAME MARS</div>
...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mt-4">
        <a href="bumi" class="btn btn-secondary btn-lg">Kembali ke Bumi</a>
        <a href="jupiter" class="btn btn-primary btn-lg">Lanjut ke Jupiter</a>
    </div>
</div>
@endsection
